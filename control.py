...
maxdata = 1073741824000 #1T,流量上限，包括流入和流出，单位Byte
...
def net_loop():
    ...
    while True:
        ...
        if totaltrans >= maxdata:
            os.system('rm -f /root/newnetcardtransdata.txt && sh /root/shadowsocksr/stop.sh && mv /root/shadowsocksr /root/out') #可以修改为其他命令
